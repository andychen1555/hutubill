...
public class ChartUtil {
    ...
    public static Image getImage(int width, int height) {
        ...
        // 样本值的字体
        chart.setFont("rangeLabelFont", new Font("Arial", Font.PLAIN, 12));
        // 显示图例说明
        chart.setLegendOn(true);
        // 把图例说明放在左侧
        chart.setLegendPosition(Chart.LEFT);
        ...
        chart.setLegendLabels(new String[]{"月消费报表"});
        // 图例说明的字体
        chart.setFont("legendFont", new Font("Dialog", Font.PLAIN, 13));
        // 下方文字的字体
        chart.setFont("sampleLabelFont", new Font("Dialog", Font.PLAIN, 13));
        // 图表中间背景颜色
        chart.setChartBackground(Color.white);
        // 图表整体背景颜色
        chart.setBackground(ColorUtil.backgroundColor);
